...
<Capability>
  ...
  <Layer>
    ...
    <Layer>
      <Name>points</Name>
      <Title>Points group</Title>
      <Abstract>points</Abstract>
    <Style>
       <Name>default</Name>
       <Title>default</Title>
       <LegendURL width="65" height="53">
          <Format>image/png</Format>
          <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://example.com/ogc?version=1.1.1&amp;service=WMS&amp;request=GetLegendGraphic&amp;layer=points&amp;format=image/png&amp;STYLE=default"/>
       </LegendURL>
    </Style>
